...
<head>
	...
	<link rel="stylesheet" type="text/css" href="tesaurus.css">
...
<body>
	...
	<div class="artikel">
		<h1>TESAURUS.ID</h1>
		<form method="post" action="tesaurus.php">
			...
			<input id="checkbox" type="checkbox" name="related" value="RelasiKata"> Relasi Kata Imbuhan
		</form>
	</div>
	<div class="hasil">
	<?php
		...
		if (isset($_POST['cari'])) {
			...
			if (!empty($_POST['cari'])) {
				...
				if (isset($_POST['related'])) {
					...
					print "<button class=\"btn relasikata\"> RELASI KATA IMBUHAN </button>";
